...
namespace ImageFilters.Filters
{
    public class MouthFilterCpu : FacePartFilterCpuBase
    {
        ...
        {
            get { return _instance ?? (_instance = new MouthFilterCpu()); }
        }

        protected override HaarCascade CascadeClassifier
        {
            get { return _cascadeClassifier ?? (_cascadeClassifier = new HaarCascade("HaarCascades\\haarcascade_mcs_mouth.xml")); }
        }

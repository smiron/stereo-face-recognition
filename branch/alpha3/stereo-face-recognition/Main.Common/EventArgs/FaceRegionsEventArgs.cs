...
namespace FaceDetection.Misc
{
    public class FaceRegionsEventArgs : EventArgs
    {
        ...
        public IEnumerable<FaceRegion2D> Left { get; private set; }

        public IEnumerable<FaceRegion2D> Right { get; private set; }

        public IEnumerable<Tuple<int, int>> Corespondences { get; private set; }

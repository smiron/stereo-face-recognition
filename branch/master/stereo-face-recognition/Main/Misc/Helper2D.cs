...
namespace FaceDetection
{
    public static class Helper2D
    {
        ...
        public static FilterInstances FilterInstances
        {
            get;
            set;
        }
            ...
            int faceWidth, int faceHeight, bool findEyes = true, bool findMouthRegions = true)
        {
            ...
            using (var gray = FilterInstances.PrepareFilter.GetResult(image, parameter))
            {
                foreach (var faceRegion in FilterInstances.FaceFilter.GetResult(gray, new FacePartParameter
                {
                    MinWidth = faceWidth,
                ...
                }))
                {
                    ...
                    using (var cropFace = FilterInstances.CropFilter.GetResult(gray, new CropParameter { Region = faceRegion }))
                    {
                        ...
                        if (findEyes)
                        {
                            ...
                            var leftEyes = FilterInstances.EyeFilter.GetResult
                            ...
                            var rightEyes = FilterInstances.EyeFilter.GetResult
                        ...
                        if (findMouthRegions)
                        {
                            ...
                            var mouths = FilterInstances.MouthFilter.GetResult(cropFace, new FacePartParameter
                            {
